Feature: Client successfully bridges out CBDC
  ...
  Scenario: Client initiates bridge out of CBDC to another user address and the operation fails
    Given "alice" with 500 CBDC available
    When "alice" escrows 500 CBDC and creates an asset reference with id "c5dfbd04-a71b-4848-92d1-78cd1fafaaf1"
    Then "alice" tries to initiate bridge out of 500 CBDC referenced by id "c5dfbd04-a71b-4848-92d1-78cd1fafaaf1" to "bob" address in the sidechain and operation fails because "it is not possible to bridge CBDC to another user"
  ...
  Scenario: Impersonator tries initiates bridge out of other user CBDC and the operation fails
    Given "alice" with 500 CBDC available
    When "alice" escrows 500 CBDC and creates an asset reference with id "c5dfbd04-a71b-4848-92d1-78cd1fafaaf1"
    Then "bob" tries to initiate bridge out of 500 CBDC referenced by id "c5dfbd04-a71b-4848-92d1-78cd1fafaaf1" to "bob" address in the sidechain and operation fails because "it is not possible to transfer tokens escrowed by another user"
