Feature: Client successfully bridges back CBDC
  ...
  Scenario: Client successfully initiates bridge back of CBDC to own address in the source chain
    ...
    Given "charlie" locks and deletes an asset reference with id "c5dfbd04-a71b-4848-92d1-78cd1fafaaf1"
  ...
  Scenario: Client successfully initiates bridge back half of the escrowed CBDC to own address in the source chain
    ...
    Then "charlie" has 0 CBDC available in the sidechain
    Then "alice" has 250 CBDC available
    Then "charlie" has 250 CBDC available
  ...
  Scenario: Client fails to initiate bridge back of CBDC to another user address in the source chain but transfer
    ...
    Given "alice" with 500 CBDC available in the sidechain smart contract
    When "alice" escrows 500 CBDC and creates an asset reference with id "d25fbcbb-0895-4905-b8d5-502d5e83b122" in the sidechain
    Then "alice" fails to initiate bridge back of 500 CBDC referenced by id "d25fbcbb-0895-4905-b8d5-502d5e83b122" to "bob" address in the source chain
    Then "alice" has 0 CBDC available
    Then "alice" has 0 CBDC available in the sidechain
    Then "charlie" has 500 CBDC available
    Then "charlie" has 500 CBDC available in the sidechain
    Then "bob" has 0 CBDC available
  ...
  Scenario: Impersonator fails to initiate bridge back of CBDC escrowed by another user address but transfer
    ...
    Given "alice" with 500 CBDC available in the sidechain smart contract
    When "alice" escrows 500 CBDC and creates an asset reference with id "d25fbcbb-0895-4905-b8d5-502d5e83b122" in the sidechain
    Then "bob" fails to initiate bridge back of 500 CBDC referenced by id "d25fbcbb-0895-4905-b8d5-502d5e83b122" to "alice" address in the source chain
    Then "alice" has 0 CBDC available
    Then "alice" has 0 CBDC available in the sidechain
    Then "charlie" has 500 CBDC available
    Then "charlie" has 500 CBDC available in the sidechain
