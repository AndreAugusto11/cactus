...
} from "@hyperledger/cactus-plugin-satp-hermes/src/main/typescript/index";
...
import { ISatpPluginKeyPair } from "@hyperledger/cactus-plugin-satp-hermes/src/main/typescript/gateway/plugin-satp-gateway";
